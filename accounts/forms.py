...
# Need to repurpose this altogether. Validation should be coming from Django and React should handle UI, but I'm not sure this is validating anything at all.
