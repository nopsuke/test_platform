...
urlpatterns = [
    ...
    # OLD path("api/login/", auth_views.LoginView.as_view(), name="login"), # Not sure if this is correct.
    ...
    # OLD path("api/logout/", auth_views.LogoutView.as_view(next_page='home'), name="logout"), # Not sure if this is correct.
    # OLD path('api/balance/', BalanceView.as_view(), name='balance'),
    # OLD path('change_leverage/', views.change_leverage, name='change_leverage'),
    # OLD path("api/register/", RegisterView.as_view(), name="register"),
    # OLD path("api/Referral/", ReferralsView.as_view(), name="Referral"),
    # OLD path("api/leverage/", LeverageView.as_view(), name="leverage"),
]
